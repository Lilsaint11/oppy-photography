...
const Hero = () => {
    ...
    console.log(dataFetched.mainImage)
    return ( 
        <>
        {dataFetched && <div className="w-full -z-50 h-72 relative sm:mb-20 max-[450px]:mb-0 mb-10">
            <motion.div
             initial={{opacity:0}}
            ...
            {dataFetched.map((data)=> (
                ...
                <motion.img 
                 ...
                 src={data.mainImage.asset.url} alt={data.title} className=" max-[710px]:w-32 max-[560px]:w-20 w-40  max-[710px]:max-h-32 max-[560px]:h-20 max-h-40 bg-cover absolute max-[560px]:top-10 top-6 max-[970px]:-left-10 max-[850px]:-left-20 left-0 -z-20"/>
            </span>      
            ))}
            <span>
                <motion.img 
