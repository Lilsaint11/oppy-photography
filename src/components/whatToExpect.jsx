const WhatToExpect = () => {
    return ( 
        <div className="flex justify-between max-[700px]:flex-col max-[700px]:gap-5">
            <div className="max-[700px]:w-full w-1/2" data-aos="fade-right"data-aos-easing="ease-out-cubic"
            ...
            <div className="max-[700px]:w-full max-[900px]:w-1/2 w-1/3" data-aos="fade-left"data-aos-easing="ease-out-cubic"
                data-aos-duration="1000">
